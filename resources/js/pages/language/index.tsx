...
const pageHeading: PageConfig = {
    module: 'language',
    heading: 'Danh sách ngôn ngữ',
    cardHeading: 'Bảng quản lý danh sách ngôn ngữ',
    cardDescription:
        'Quản lý thông tin danh sách ngôn ngữ, sử dụng các chức năng để lọc dữ liệu',
};
...
export default function LanguageIndex() {
    ...
    const fetchLanguages = async (searchQuery = '') => {
        try {
            setLoading(true);
    ...
    const toggleSelectAll = () => {
        if (selectedIds.length === languages.length) {
            ...
            setSelectedIds(languages.map((item) => item.id));
        }
    };
                        ...
                        <div className="mb-[20px] flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="min-w-[120px] text-sm font-medium text-zinc-500">
                                    {loading
                                        ? 'Đang tải...'
                                        : `Tổng số: ${languages.length} bản ghi`}
                                </div>
                                    ...
                                    {loading ? (
                                        ...
                                        languages.map((item) => (
                                            ...
                                            >
                                                ...
                                                <td className="max-w-[200px] truncate p-4 align-middle text-zinc-500">
                                                    {item.description}
                                                </td>
