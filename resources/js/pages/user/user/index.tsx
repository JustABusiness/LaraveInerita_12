        ...
        try {
            ...
            const response = await api.get('/user', {
                params: {
                    ...
                    user_catalogue_id:
                        catalogueId !== 'all' ? catalogueId : undefined,
                },
            });
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-zinc-50/80">
                                    <tr className="border-b border-zinc-200">
                                        ...
                                        <th className="h-12 w-16 px-4 text-left align-middle text-[11px] font-bold tracking-wider text-zinc-900 uppercase">
                                            ID
                                        </th>
                                        ...
                                        <th className="h-12 w-24 px-4 text-right align-middle text-[11px] font-bold tracking-wider text-zinc-900 uppercase">
                                            Thao tác
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    {loading ? (
                                        ...
                                        users.map((item) => (
                                            ...
                                            >
                                                ...
                                                <td
                                                    className="max-w-[200px] truncate p-4 align-middle text-zinc-600"
